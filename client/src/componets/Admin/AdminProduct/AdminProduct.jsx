  ...
  const columns = [
    {
      ...
      accessor: "_id",
      Cell: ({ value }) => {
        let doc= value?.slice(0,7);
       return <div dangerouslySetInnerHTML={{ __html: doc }}></div>
      }
    },
    {
      Header: "Name",
          ...
          <div className="drawer-form-product">
            <form action="" onSubmit={handleSubmit(onCreate)}>
              ...
              >
                <label>Màu</label>
                <select
                  style={{ width: "35%", height: "30px", margin: "8px 8px", outline: "none", borderRadius:"10px",  }}
                  id="category"
